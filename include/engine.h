...
public:
    ...
    bool is_empty_square(int i, int bit);                                                                          // Checks if a square on the chess board is empty
    ...
    bool add_piece_move(vector<Move> &moves, Move &move, U64 opposite_board, char capture_color, int board_index); // Adds a move for a specific piece
